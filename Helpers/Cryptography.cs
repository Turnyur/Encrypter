...
namespace Encrypter.Helpers
{
    public static class Cryptography
    {
        ...
        private static string initVect = "@1B2c3D4e5F6g7H8";
        private static int Iterations = 3;
        private static string hashstring = "SHA1";
        private static string saltV = "EZHUTHELLAM";
        ...
        public static string Decrypt(string cipherText, string passPhrase, string hashAlgorithm, int passwordIterations)
        {
            string functionReturnValue = null;
